...
Процедура ОбработкаПроведения(Отказ,Режим)
	...
	// ПРИ ПРОВЕДЕНИИ НАЧИСЛЯЮТСЯ/СПИСЫВАЮТСЯ БОНУСЫ
...
Процедура НачислитьСписатьБонусныеБаллы(Отказ)
	...
	ДоляНакапливаемыхБаллов = ДоляНакапливаемыхБаллов(СуммаПокупокКлиентов);
...
Функция ДоляНакапливаемыхБаллов(СуммаПокупокКлиентов)
	Запрос = Новый Запрос;
	Запрос.Текст = 
		"ВЫБРАТЬ
